...
lazy val fragnosticProject = Project(
  id = "fragnostic-selenium-project",
  base = file(".")).settings(
    fragnosticSettings ++ Seq(
    name := "fragnostic-selenium",
    ...
    description := "fragnostic-selenium",
    shellPrompt := { state =>
...
lazy val fragnosticSelenium = Project(
  id = "fragnostic-selenium",
  base = file("fragnostic-selenium")).settings(fragnosticSettings ++ Seq(
